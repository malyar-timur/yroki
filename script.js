  ...
  const chatScenarios = [
    {
      ...
      options: [
        ...
        {
          text: 'Я не против, отправь мне ссылку в личные сообщения.',
          type: 'danger',
          points: 0,
        ...
        {
          text: 'Правила безопасности запрещают вводить пароли на сторонних сайтах.',
          type: 'success',
          points: 10,
    ...
    },
    {
      ...
      options: [
        ...
        {
          text: 'Я не боюсь вирусов, сейчас установлю этот чит.',
          type: 'danger',
          points: 0,
        ...
        {
          text: 'Безопаснее скачивать программы только с официальных сайтов, не отключая защиту.',
          type: 'success',
          points: 10,
    ...
    },
    {
      ...
      options: [
        ...
        {
          text: 'Я не против прокачки, но давай ты сначала зайдешь к другу?',
          type: 'danger',
          points: 0,
          explanation: 'Внимание! Давать чужие пароли так же опасно и нечестно. Подвергать риску чужой аккаунт нельзя.'
        },
        {
          text: 'Мой пароль — это секрет, его нельзя сообщать никому, даже модераторам.',
          type: 'success',
          points: 10,
    ...
    },
    {
      ...
      options: [
        ...
        {
          text: 'Я не против получить гемы, но фото будет немного размытым.',
          type: 'danger',
          points: 0,
          explanation: 'Внимание! Мошенники будут выманивать и обратную сторону с секретным кодом CVC. Не отправляй ничего.'
        },
        {
        ...
        {
          text: 'Данные банковских карт родителей должны оставаться в строгом секрете.',
          type: 'success',
          points: 10,
    ...
    },
    {
      ...
      options: [
        ...
        {
          text: 'Я не боюсь темноты, давай встретимся в 22:00 за ТЦ?',
          type: 'danger',
          points: 0,
          explanation: 'Ошибка! Встречи в темное время суток повышают опасность. Не соглашайся на контакт.'
        },
        {
          text: 'Встречи с людьми из интернета без ведома родителей категорически запрещены.',
          type: 'success',
          points: 10,
    ...
    },
    {
      ...
      options: [
        ...
        {
          text: 'Я не скрываю свой контакт, записывай номер...',
          type: 'danger',
          points: 0,
        ...
        {
          text: 'Личные контакты вроде номера телефона нельзя разглашать посторонним.',
          type: 'success',
          points: 10,
    ...
    },
    {
      ...
      options: [
        ...
        {
          text: 'Я не знаю свой IP, но сейчас спрошу у провайдера.',
          type: 'danger',
          points: 0,
        ...
        {
          text: 'Сетевые адреса устройств должны быть скрыты, чтобы избежать кибератак.',
          type: 'success',
          points: 10,
    ...
    },
    {
      ...
      options: [
        ...
        {
          text: 'Я не против подарков, сейчас напишу наш почтовый индекс.',
          type: 'danger',
          points: 0,
        ...
        {
          text: 'Домашний адрес — это конфиденциальная информация, которую нельзя сообщать.',
          type: 'success',
          points: 10,
    ...
    },
    {
      ...
      options: [
        ...
        {
          text: 'Я не сижу дома один, но родителей обычно нет до 19:00.',
          type: 'danger',
          points: 0,
        ...
        {
          text: 'Информация о школе и моем распорядке дня должна оставаться тайной.',
          type: 'success',
          points: 10,
    ...
    },
    {
      ...
      options: [
        ...
        {
          text: 'Я не уверен, что это безопасно, но ладно, держи код...',
          type: 'danger',
          points: 0,
        ...
        {
          text: 'Передавать кому-либо входящие SMS-коды категорически запрещено.',
          type: 'success',
          points: 10,
