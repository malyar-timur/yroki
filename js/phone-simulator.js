document.addEventListener('DOMContentLoaded', () => {
  ...
  // List of 11 realistic phone scam scenarios with pre-generated MP3 neural voice files
  const phoneScams = [
    {
    ...
    },
    {
      ...
      feedbackSuccess: 'Умница! Вы проигнорировали фейковый штраф и спасли баланс банковских карт родителей.'
    },
    {
